...
def calculate_demographic_data(print_data=True):
    # Read data from file
    df = pd.read_csv('/Users/bayusedana/Documents/GitHub/Python-Projects/Projects/Demographic Data Analyzer/adult.data.csv')
    ...
    num_min_workers = df[df['hours-per-wekk'] == min_work_hours]
